...
Usage: python3 tests/test_quadratics_solving_with_square_roots.py <template_number>
"""
...
try:
    import quadratics_solving_with_square_roots as swr
except ImportError:
    print("Error: Could not import quadratics_quadratics_solving_with_square_roots.py")
...
def main():
    if len(sys.argv) != 2:
        print("Usage: python3 tests/test_quadratics_solving_with_square_roots.py <template_number>")
        print("Example: python3 tests/test_quadratics_solving_with_square_roots.py 1")
        sys.exit(1)
