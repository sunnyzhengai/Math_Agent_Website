...
Usage: python3 tests/test_graphing_and_application.py <template_number>
"""
...
try:
    import graphing_and_application as ga
except ImportError:
    print("Error: Could not import graphing_and_application.py")
...
def main():
    if len(sys.argv) != 2:
        print("Usage: python3 tests/test_graphing_and_application.py <template_number>")
        print("Example: python3 tests/test_graphing_and_application.py 1")
        sys.exit(1)
